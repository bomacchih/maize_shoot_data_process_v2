...
| 7 | Cluster developmental expression trends, analyze GO enrichment  | [`scripts/R/07_developmental_trends_GO/`](scripts/R/07_developmental_trends_GO/) |
...
| 11 | Export domain-level RNA sums/means, reconstruct the embryonic-leaf TO-GCN, plot panels D/E, and prepare level-specific GO inputs | [`scripts/R/11_TO_GCN/`](scripts/R/11_TO_GCN/), [`scripts/shell/11_TO_GCN/`](scripts/shell/11_TO_GCN/), and [`scripts/python/show_cluster_expr.py`](scripts/python/show_cluster_expr.py) |
...
- [02 — Load Space Ranger outputs](docs/02_Load_Space_Ranger_outputs.md)
- [03 — Add spot metadata to Seurat v5 objects](docs/03_Add_spot_metadata_Seurat_v5.md)
- [04 — QC, SCTransform, Harmony integration, and clustering](docs/04_QC_SCT_Harmony_workflow.md)
- [04 — Seurat v5 maize spatial dataset](docs/04_Maize_data_Seurat_v5.md)
