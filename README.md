...
| 6 | Generate replicate-level pseudobulk profiles and Figure 8 | [`scripts/R/06_pseudobulk_analysis/`](scripts/R/06_pseudobulk_analysis/) |
...
Place one Velocyto loom file for each of the 14 samples in `data/raw/loom/`. Filenames must contain their sample IDs. Validate filenames and metadata correspondence without running the numerical analysis:
