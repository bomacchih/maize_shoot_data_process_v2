...
| SCINA marker table | `data/metadata/scRNA_reference/SCINA_marker_table.csv`; source: `marker_list2.rds`, compared with Supplementary Table 9 | **PRESENT — 3,997 MARKERS FOR 14 CELL TYPES** | Exact Table-9 subset with repeated and cross-cell-type genes removed; all retained genes occur in the combined scRNA reference and Visium feature space; see `data/metadata/scRNA_reference/README.md` |
